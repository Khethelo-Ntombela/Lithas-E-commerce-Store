...
// 1. Tell PayFast we acknowledge receipt of the notification
header('HTTP/1.1 200 OK');

// 2. Grab all incoming POST data sent securely from PayFast
$pfData = $_POST;
...
// 3. Extract key data fields passed back from the gateway
...
// 4. Validate payment success credentials
